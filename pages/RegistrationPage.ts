...
export class RegistrationPage extends BasePage {
  ...
  constructor(page: Page, testContext: TestContext) {
    ...
    this.lbl_errorConfirmPassword = page.locator(
  ...
  async generateAndRegisterNewUser(request: APIRequestContext) {
    ...
    const { firstName, lastName, username, password } =
      this.testContext.userdata.user;
  ...
  async verifyRegistrationEmptyFieldErrorHandling() {
    console.log(
      "RegistrationPage - verifyRegistrationEmptyFieldErrorHandling()",
    );
    await this.clearAndBlur(this.inp_firstName);
    await this.assertInnerText(
      this.lbl_errorFirstName,
